 ...
 * Original file: /npm/gsap@1.20.3/TweenMax.js
 *
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                var s = function(t) {
                    ...
                    _ = [];
                n.version = "1.20.3", h.constructor = n, h.kill()._gc = !1, n.killTweensOf = n.killDelayedCallsTo = i.killTweensOf, n.getTweensOf = i.getTweensOf, n.lagSmoothing = i.lagSmoothing, n.ticker = i.ticker, n.render = i.render, h.invalidate = function() {
                    ...
                    var r, n, o, l, h, _, u, f, c, p = this._dirty ? this.totalDuration() : this._totalDuration,
                        d = this._time,
                        m = this._totalTime,
                        g = this._cycle,
                        y = this._duration,
                ...
                var s = function(t) {
                    ...
                    d = s.prototype = new e;
                return s.version = "1.20.3", d.constructor = s, d.kill()._gc = d._forcingPlayhead = d._hasPause = !1, d.to = function(t, e, s, r) {
                    ...
                    var s, r, n, a, o, _, u, f = this._time,
                        c = this._dirty ? this.totalDuration() : this._totalDuration,
                        p = this._startTime,
                        d = this._timeScale,
                        m = this._paused;
                    if (f !== this._time && (t += this._time - f), t >= c - 1e-7 && t >= 0) this._totalTime = this._time = c, this._reversed || this._hasPausedChild() || (r = !0, a = "onComplete", o = !!this._timeline.autoRemoveChildren, 0 === this._duration && (t <= 0 && t >= -1e-7 || this._rawPrevTime < 0 || 1e-10 === this._rawPrevTime) && this._rawPrevTime !== t && this._first && (o = !0, this._rawPrevTime > 1e-10 && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : 1e-10, t = c + 1e-4;
                    else if (t < 1e-7)
                        if (this._totalTime = this._time = 0, (0 !== f || 0 === this._duration && 1e-10 !== this._rawPrevTime && (this._rawPrevTime > 0 || t < 0 && this._rawPrevTime >= 0)) && (a = "onReverseComplete", r = this._reversed), t < 0) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (o = r = !0, a = "onReverseComplete") : this._rawPrevTime >= 0 && this._first && (o = !0), this._rawPrevTime = t;
                        else {
                ...
                var s = function(e) {
                    ...
                    h = s.prototype = new t;
                return h.constructor = s, h.kill()._gc = !1, s.version = "1.20.3", h.invalidate = function() {
                    ...
                    this._gc && this._enabled(!0, !1);
                    var s, r, o, l, h, _, u, f, c = this._time,
                    ...
                    if (c !== this._time && (t += this._time - c), t >= p - 1e-7 && t >= 0) this._locked || (this._totalTime = p, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (r = !0, l = "onComplete", h = !!this._timeline.autoRemoveChildren, 0 === this._duration && (t <= 0 && t >= -1e-7 || v < 0 || 1e-10 === v) && v !== t && this._first && (h = !0, v > 1e-10 && (l = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : 1e-10, this._yoyo && 0 != (1 & this._cycle) ? this._time = t = 0 : (this._time = d, t = d + 1e-4);
                        ...
                        if (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== c || 0 === d && 1e-10 !== v && (v > 0 || t < 0 && v >= 0) && !this._locked) && (l = "onReverseComplete", r = this._reversed), t < 0) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (h = r = !0, l = "onReverseComplete") : v >= 0 && this._first && (h = !0), this._rawPrevTime = t;
                        else {
                        ...
                        if ((t = this._time) >= c || this._repeat && x !== this._cycle)
                    ...
                    if (this._time !== c && this._first || i || h || u) {
                        if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== m && t > 0 && (this._active = !0), 0 === m && this.vars.onStart && (0 === this._totalTime && this._totalDuration || e || this._callback("onStart")), (f = this._time) >= c)
            ...
            function() {
                var t = 180 / Math.PI,
                    ...
                    _ = function(t, n, a, o, _, u) {
                        ...
                        if (!o) {
                            for (f = x.length; --f > -1;)
                                if (r[c])
                                    for (g = (p = T[x[f]]).length - 1, d = 0; d < g; d++) m = p[d + 1].da / i[d] + p[d].da / e[d] || 0, s[d] = (s[d] || 0) + m * m;
                ...
                var _, u, f, c, p, d, m, g, y = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                    ...
                    it = function(t, e) {
                        ...
                        if (e = e || K(t, null))
                            if (i = e.length)
                                for (; --i > -1;) - 1 !== (r = e[i]).indexOf("-transform") && At !== r || (n[r.replace(R, C)] = e.getPropertyValue(r));
                            else
                                for (i in e) - 1 !== i.indexOf("Transform") && Rt !== i || (n[i] = e[i]);
                        else if (e = t.currentStyle || t.style)
                            for (i in e) "string" == typeof i && void 0 === n[i] && (n[i.replace(R, C)] = e[i]);
                        return W || (n.opacity = G(t)), s = jt(t, e, !1), n.rotation = s.rotation, n.skewX = s.skewX, n.scaleX = s.scaleX, n.scaleY = s.scaleY, n.x = s.x, n.y = s.y, Dt && (n.z = s.z, n.rotationX = s.rotationX, n.rotationY = s.rotationY, n.scaleZ = s.scaleZ), n.filters && delete n.filters, n
                    },
                        ...
                        if (t)
                            if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                                ...
                                if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), ut[t]) i = ut[t];
                                    ...
                                    } else a = Number(i[0]) % 360 / 360, o = Number(i[1]) / 100, s = 2 * (l = Number(i[2]) / 100) - (r = l <= .5 ? l * (o + 1) : l + o - l * o), i.length > 3 && (i[3] = Number(i[3])), i[0] = ft(a + 1 / 3, s, r), i[1] = ft(a, s, r), i[2] = ft(a - 1 / 3, s, r);
                ...
                var mt = function(t, e, i, s) {
                    ...
                    xt = a.parseComplex = function(t, e, i, s, r, n, o, l, h, u) {
                        ...
                        var f, c, p, d, T, x, b, w, P, O, S, k, R, A = i.split(", ").join(",").split(" "),
                            ...
                            D = A.length,
                            M = !1 !== _;
                        for (-1 === s.indexOf(",") && -1 === i.indexOf(",") || (-1 !== (s + i).indexOf("rgb") || -1 !== (s + i).indexOf("hsl") ? (A = A.join(" ").replace(z, ", ").split(" "), C = C.join(" ").replace(z, ", ").split(" ")) : (A = A.join(" ").split(",").join(", ").split(" "), C = C.join(" ").split(",").join(", ").split(" ")), D = A.length), D !== C.length && (D = (A = (n || "").split(" ")).length), o.plugin = h, o.setRatio = u, dt.lastIndex = 0, f = 0; f < D; f++)
                            if (d = A[f], T = C[f], (w = parseFloat(d)) || 0 === w) o.appendXtra("", w, lt(T, w), T.replace(v, ""), M && -1 !== T.indexOf("px"), !0);
                            else if (r && dt.test(d)) k = ")" + ((k = T.indexOf(")") + 1) ? T.substr(k) : ""), R = -1 !== T.indexOf("hsl") && W, O = T, d = ct(d, R), T = ct(T, R), (P = d.length + T.length > 6) && !W && 0 === T[3] ? (o["xs" + o.l] += o.l ? " transparent" : "transparent", o.e = o.e.split(C[f]).join("transparent")) : (W || (P = !1), R ? o.appendXtra(O.substr(0, O.indexOf("hsl")) + (P ? "hsla(" : "hsl("), d[0], lt(T[0], d[0]), ",", !1, !0).appendXtra("", d[1], lt(T[1], d[1]), "%,", !1).appendXtra("", d[2], lt(T[2], d[2]), P ? "%," : "%" + k, !1) : o.appendXtra(O.substr(0, O.indexOf("rgb")) + (P ? "rgba(" : "rgb("), d[0], T[0] - d[0], ",", !0, !0).appendXtra("", d[1], T[1] - d[1], ",", !0).appendXtra("", d[2], T[2] - d[2], P ? "," : k, !0), P && (d = d.length < 4 ? 1 : d[3], o.appendXtra("", d, (T.length < 4 ? 1 : T[3]) - d, k, !1))), dt.lastIndex = 0;
                        else if (x = d.match(y)) {
                            if (!(b = T.match(v)) || b.length !== x.length) return o;
                            for (p = 0, c = 0; c < x.length; c++) S = x[c], O = d.indexOf(S, p), o.appendXtra(d.substr(p, O - p), Number(S), lt(b[c], S), "", M && "px" === d.substr(O + S.length, 2), 0 === c), p = O + S.length;
                            o["xs" + o.l] += d.substr(p)
                ...
                var St, kt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    It = function() {
                        ...
                        return B.createElementNS && !s && (t = zt("svg", Et), i = (e = zt("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        })).getBoundingClientRect().width, e.style[Ct] = "50% 50%", e.style[Rt] = "scaleX(0.5)", s = i === e.getBoundingClientRect().width && !(c && Dt), Et.removeChild(t)), s
                    }(),
                    ...
                    Yt = function(t, e) {
                        var i, s, r, n, a, o, l = t._gsTransform || new Mt,
                            h = t.style;
                        if (Rt ? s = J(t, At, null, !0) : t.currentStyle && (s = (s = t.currentStyle.filter.match(M)) && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), i = !s || "none" === s || "matrix(1, 0, 0, 1, 0, 0)" === s, !Rt || !(o = !K(t) || "none" === K(t).display) && t.parentNode || (o && (n = h.display, h.display = "block"), t.parentNode || (a = 1, Et.appendChild(t)), i = !(s = J(t, At, null, !0)) || "none" === s || "matrix(1, 0, 0, 1, 0, 0)" === s, n ? h.display = n : o && qt(h, "display"), a && Et.removeChild(t)), (l.svg || t.getCTM && Lt(t)) && (i && -1 !== (h[Rt] + "").indexOf("matrix") && (s = h[Rt], i = 0), r = t.getAttribute("transform"), i && r && (-1 !== r.indexOf("matrix") ? (s = r, i = 0) : -1 !== r.indexOf("translate") && (s = "matrix(1,0,0,1," + r.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return Bt;
                        for (r = (s || "").match(y) || [], bt = r.length; --bt > -1;) n = Number(r[bt]), r[bt] = (a = n - (n |= 0)) ? (1e5 * a + (a < 0 ? -.5 : .5) | 0) / 1e5 + n : n;
                        return e && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r
                    },
                    jt = V.getTransform = function(t, i, s, r) {
                        if (t._gsTransform && s && !r) return t._gsTransform;
                        var n, o, l, h, _, u, f = s ? t._gsTransform || new Mt : new Mt,
                            c = f.scaleX < 0,
                            p = Dt ? parseFloat(J(t, Ct, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin || 0 : 0,
                            d = parseFloat(a.defaultTransformPerspective) || 0;
                        if (f.svg = !(!t.getCTM || !Lt(t)), f.svg && (Xt(t, J(t, Ct, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), St = a.useSVGTransformAttr || It), (n = Yt(t)) !== Bt) {
                            if (16 === n.length) {
                                var m, g, y, v, T, x = n[0],
                                    b = n[1],
                                    w = n[2],
                    ...
                    Ut = V.set3DTransformRatio = V.setTransformRatio = function(t) {
                        var e, i, s, r, n, a, o, l, h, _, u, f, p, d, m, g, y, v, T, x, b, w = this.data,
                            P = this.t.style,
                            O = w.rotation,
                            S = w.rotationX,
                            k = w.rotationY,
                            ...
                            N = w.skewY,
                            L = w.skewX;
                        if (N && (L += N, O += N), !((1 !== t && 0 !== t || "auto" !== X || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && X || F || E || k || S || 1 !== C) || St && z || !Dt) O || L || z ? (O *= I, x = L * I, b = 1e5, i = Math.cos(O) * R, n = Math.sin(O) * R, s = Math.sin(O - x) * -A, a = Math.cos(O - x) * A, x && "simple" === w.skewType && (e = Math.tan(x - N * I), s *= e = Math.sqrt(1 + e * e), a *= e, N && (e = Math.tan(N * I), i *= e = Math.sqrt(1 + e * e), n *= e)), z && (D += w.xOrigin - (w.xOrigin * i + w.yOrigin * s) + w.xOffset, M += w.yOrigin - (w.xOrigin * n + w.yOrigin * a) + w.yOffset, St && (w.xPercent || w.yPercent) && (m = this.t.getBBox(), D += .01 * w.xPercent * m.width, M += .01 * w.yPercent * m.height), D < (m = 1e-6) && D > -m && (D = 0), M < m && M > -m && (M = 0)), T = (i * b | 0) / b + "," + (n * b | 0) / b + "," + (s * b | 0) / b + "," + (a * b | 0) / b + "," + D + "," + M + ")", z && St ? this.t.setAttribute("transform", "matrix(" + T) : P[Rt] = (w.xPercent || w.yPercent ? "translate(" + w.xPercent + "%," + w.yPercent + "%) matrix(" : "matrix(") + T) : P[Rt] = (w.xPercent || w.yPercent ? "translate(" + w.xPercent + "%," + w.yPercent + "%) matrix(" : "matrix(") + R + ",0,0," + A + "," + D + "," + M + ")";
                        else {
                            if (c && (R < (m = 1e-4) && R > -m && (R = C = 2e-5), A < m && A > -m && (A = C = 2e-5), !E || w.z || w.rotationX || w.rotationY || (E = 0)), O || L) O *= I, g = i = Math.cos(O), y = n = Math.sin(O), L && (O -= L * I, g = Math.cos(O), y = Math.sin(O), "simple" === w.skewType && (e = Math.tan((L - N) * I), g *= e = Math.sqrt(1 + e * e), y *= e, w.skewY && (e = Math.tan(N * I), i *= e = Math.sqrt(1 + e * e), n *= e))), s = -y, a = g;
                            else {
                                if (!(k || S || 1 !== C || E || z)) return void(P[Rt] = (w.xPercent || w.yPercent ? "translate(" + w.xPercent + "%," + w.yPercent + "%) translate3d(" : "translate3d(") + D + "px," + M + "px," + F + "px)" + (1 !== R || 1 !== A ? " scale(" + R + "," + A + ")" : ""));
                                i = a = 1, s = n = 0
                            }
                            _ = 1, r = o = l = h = u = f = 0, p = E ? -1 / E : 0, d = w.zOrigin, m = 1e-6, ",", "0", (O = k * I) && (g = Math.cos(O), l = -(y = Math.sin(O)), u = p * -y, r = i * y, o = n * y, _ = g, p *= g, i *= g, n *= g), (O = S * I) && (e = s * (g = Math.cos(O)) + r * (y = Math.sin(O)), v = a * g + o * y, h = _ * y, f = p * y, r = s * -y + r * g, o = a * -y + o * g, _ *= g, p *= g, s = e, a = v), 1 !== C && (r *= C, o *= C, _ *= C, p *= C), 1 !== A && (s *= A, a *= A, h *= A, f *= A), 1 !== R && (i *= R, n *= R, l *= R, u *= R), (d || z) && (d && (D += r * -d, M += o * -d, F += _ * -d + d), z && (D += w.xOrigin - (w.xOrigin * i + w.yOrigin * s) + w.xOffset, M += w.yOrigin - (w.xOrigin * n + w.yOrigin * a) + w.yOffset), D < m && D > -m && (D = "0"), M < m && M > -m && (M = "0"), F < m && F > -m && (F = 0)), T = w.xPercent || w.yPercent ? "translate(" + w.xPercent + "%," + w.yPercent + "%) matrix3d(" : "matrix3d(", T += (i < m && i > -m ? "0" : i) + "," + (n < m && n > -m ? "0" : n) + "," + (l < m && l > -m ? "0" : l), T += "," + (u < m && u > -m ? "0" : u) + "," + (s < m && s > -m ? "0" : s) + "," + (a < m && a > -m ? "0" : a), S || k || 1 !== C ? (T += "," + (h < m && h > -m ? "0" : h) + "," + (f < m && f > -m ? "0" : f) + "," + (r < m && r > -m ? "0" : r), T += "," + (o < m && o > -m ? "0" : o) + "," + (_ < m && _ > -m ? "0" : _) + "," + (p < m && p > -m ? "0" : p) + ",") : T += ",0,0,0,0,1,0,", T += D + "," + M + "," + F + "," + (E ? 1 + -F / E : 1) + ")", P[Rt] = T
                        }
                    };
                (h = Mt.prototype).x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, Pt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                ...
                Pt("opacity,alpha,autoAlpha", {
                    ...
                    parser: function(t, e, i, s, n, a) {
                        var o = parseFloat(J(t, "opacity", r, !1, "1")),
                            l = t.style,
                            h = "autoAlpha" === i;
                        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + o), h && 1 === o && "hidden" === J(t, "visibility", r) && 0 !== e && (o = 0), W ? n = new vt(l, "opacity", o, e - o, n) : ((n = new vt(l, "opacity", 100 * o, 100 * (e - o), n)).xn1 = h ? 1 : 0, l.zoom = 1, n.type = 2, n.b = "alpha(opacity=" + n.s + ")", n.e = "alpha(opacity=" + (n.s + n.c) + ")", n.data = t, n.plugin = a, n.setRatio = Vt), h && ((n = new vt(l, "visibility", 0, 0, n, -1, null, !1, 0, 0 !== o ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")).xs0 = "inherit", s._overwriteProps.push(n.n), s._overwriteProps.push(i)), n
                    }
                });
                var qt = function(t, e) {
                ...
                Pt("className", {
                    parser: function(t, e, s, n, a, o, l) {
                        var h, _, u, f, c, p = t.getAttribute("class") || "",
                            d = t.style.cssText;
                        if (a = n._classNamePT = new vt(t, s, 0, 0, a, 2), a.setRatio = Wt, a.pr = -11, i = !0, a.b = p, _ = it(t, r), u = t._gsClassPT) {
                ...
                var Gt = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) a.cssText = "", r = !0;
                            ...
                            for (s = (e = this.e.split(" ").join("").split(",")).length; --s > -1;) i = e[s], l[i] && (l[i].parse === o ? r = !0 : i = "transformOrigin" === i ? Ct : l[i].p), qt(a, i);
                        r && (qt(a, Rt), (n = this.t._gsTransform) && (n.svg && (this.t.removeAttribute("data-svg-origin"), this.t.removeAttribute("transform")), delete this.t._gsTransform))
                    }
                };
                for (Pt("clearProps", {
                        parser: function(t, e, s, r, n) {
                            return n = new vt(t, s, 0, 0, n, 2), n.setRatio = Gt, n.e = e, n.pr = -10, n.data = r._tween, i = !0, n
                        }
                ...
                (h = a.prototype)._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, o, h) {
                    ...
                    var c, y, v, T, x, O, S, k, R, A = t.style;
                    if (u && "" === A.zIndex && ("auto" !== (c = J(t, "zIndex", r)) && "" !== c || this._addLazySet(A, "zIndex", 0)), "string" == typeof e && (T = A.cssText, c = it(t, r), A.cssText = T + ";" + e, c = st(t, c, it(t)).difs, !W && P.test(e) && (c.opacity = parseFloat(RegExp.$1)), e = c, A.cssText = T), e.className ? this._firstPT = y = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = y = this.parse(t, e, null), this._transformType) {
                        for (R = 3 === this._transformType, Rt ? f && (u = !0, "" === A.zIndex && ("auto" !== (S = J(t, "zIndex", r)) && "" !== S || this._addLazySet(A, "zIndex", 0)), p && this._addLazySet(A, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (R ? "visible" : "hidden"))) : A.zoom = 1, v = y; v && v._next;) v = v._next;
                        k = new vt(t, "transform", 0, 0, null, 2), this._linkCSSP(k, null, v), k.setRatio = Rt ? Ut : function(t) {
                            var e, i, s = this.data,
                                r = -s.rotation * I,
                                n = r + s.skewX * I,
                        ...
                        }, k.data = this._transform || jt(t, r, !0), k.tween = o, k.pr = -1, n.pop()
                    }
                    if (i) {
                        for (; y;) {
                            for (O = y._next, v = T; v && v.pr > y.pr;) v = v._next;
                            (y._prev = v ? v._prev : x) ? y._prev._next = y: T = y, (y._next = v) ? v._prev = y : x = y, y = O
                        }
                        this._firstPT = T
                    }
                    return !0
                    ...
                    this._transform = this._transform || jt(this._target, r, !0), this._transformType = this._transform.svg && St || !t && 3 !== this._transformType ? 2 : 3
                };
                var Zt = function(t) {
                ...
                var Ht = function(t, e, i) {
                    ...
                    if (t.slice)
                        ...
                        for (r = (s = t.childNodes).length; --r > -1;) a = (n = s[r]).type, n.style && (e.push(it(n)), i && i.push(n)), 1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || Ht(n, e, i)
                };
                return a.cascadeTo = function(t, i, s) {
                    ...
                    for (t = l._targets || l.target, Ht(t, _, f), l.render(i, !0, !0), Ht(t, u), l.render(0, !0, !0), l._enabled(!0), r = f.length; --r > -1;)
    ...
    function(t, e) {
        ...
        if (!r.TweenLite) {
            var n, a, o, l, h, _ = function(t) {
                ...
                m = function(e, s, n, a) {
                    ...
                    this.check = function(l) {
                        for (var h, u, f, c, p = s.length, g = p; --p > -1;)(h = d[s[p]] || new m(s[p], [])).gsClass ? (o[p] = h.gsClass, g--) : l && h.sc.push(this);
                        if (0 === g && n) {
                            if (u = ("com.greensock." + e).split("."), f = u.pop(), c = _(u.join("."))[f] = this.gsClass = n.apply(n, o), a)
                                if (r[f] = i[f] = c, "undefined" != typeof module && module.exports)
                                    if ("TweenMax" === e) {
            ...
            var v = [0, 0, 1, 1],
                ...
                b = T.register = function(t, e, i, s) {
                    for (var r, n, a, o, l = e.split(","), h = l.length, _ = (i || "easeIn,easeOut,easeInOut").split(","); --h > -1;)
                        for (n = l[h], r = s ? y("easing." + n, null, !0) : u.easing[n] || {}, a = _.length; --a > -1;) o = _[a], x[n + "." + o] = x[o + n] = r[o] = t.getRatio ? t : t[o] || new t
                };
            for ((o = T.prototype)._calcEnd = !1, o.getRatio = function(t) {
                ...
                }, a = (n = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length; --a > -1;) o = n[a] + ",Power" + a, b(new T(null, null, 1, a), o, "easeOut", !0), b(new T(null, null, 2, a), o, "easeIn" + (0 === a ? ",easeNone" : "")), b(new T(null, null, 3, a), o, "easeInOut");
            ...
            l = R.ticker = new u.Ticker, (o = R.prototype)._dirty = o._gc = o._initted = o._paused = !1, o._totalTime = o._time = 0, o._rawPrevTime = -1, o._next = o._last = o._onUpdate = o._timeline = o.timeline = null, o._paused = !1;
            var A = function() {
                h && S() - k > 2e3 && ("hidden" !== s.visibilityState || !l.lagSmoothing()) && l.wake();
            ...
            A(), o.play = function(t, e) {
                ...
                if (this._timeline) {
                    ...
                    this._gc && this._enabled(!0, !1), this._totalTime === t && 0 !== this._duration || (F.length && H(), this.render(t, e, !1), F.length && H())
                }
                return this
            ...
            (o = D.prototype = new R).constructor = D, o.kill()._gc = !1, o.ratio = 0, o._firstPT = o._targets = o._overwrittenProps = o._startAt = null, o._notifyPluginsOfEnabled = o._lazy = !1, D.version = "1.20.3", D.defaultEase = o._ease = new T(null, null, 1, 1), D.defaultOverwrite = "auto", D.ticker = l, D.autoSleep = 120, D.lagSmoothing = function(t, e) {
                l.lagSmoothing(t, e)
            ...
            var F = [],
                ...
                N = function(t, e, i, s) {
                    var r, n, a, o, l, h, _, u = [],
                        ...
                        c = "",
                        p = 0;
                    for (u.start = t, u.end = e, t = u[0] = t + "", e = u[1] = e + "", i && (i(u), t = u[0], e = u[1]), u.length = 0, r = t.match(E) || [], n = e.match(E) || [], s && (s._next = null, s.blob = 1, u._firstPT = u._applyPT = s), l = n.length, o = 0; o < l; o++) _ = n[o], c += (h = e.substr(f, e.indexOf(_, f) - f)) || !o ? h : ",", f += h.length, p ? p = (p + 1) % 5 : "rgba(" === h.substr(-5) && (p = 1), _ === r[o] || r.length <= o ? c += _ : (c && (u.push(c), c = ""), a = parseFloat(r[o]), u.push(a), u._firstPT = {
                        _next: u._firstPT,
                        t: u,
                        p: u.length - 1,
                        s: a,
                    ...
                    return (c += e.substr(f)) && u.push(c), u.setRatio = X, I.test(e) && (u.end = null), u
                },
                L = function(t, e, i, s, r, n, a, o, l) {
                    ...
                    if (("number" != typeof u || "number" != typeof s && !f) && (a || isNaN(u) || !f && isNaN(s) || "boolean" == typeof u || "boolean" == typeof s ? (c.fp = a, c = {
                            t: N(u, f ? parseFloat(c.s) + c.c : s, o || D.defaultStringFilter, c),
                            p: "setRatio",
                            s: 0,
                            c: 1,
                            f: 2,
            ...
            G._startTime = l.time, W._startTime = l.frame, G._active = W._active = !0, setTimeout(H, 1), R._updateRoot = D.render = function() {
                var t, e, i;
                if (F.length && H(), G.render((l.time - G._startTime) * G._timeScale, !1, !1), W.render((l.frame - W._startTime) * W._timeScale, !1, !1), F.length && H(), l.frame >= Z) {
            ...
            o._init = function() {
                ...
                if (a.startAt) {
                    ...
                    if (r.data = "isStart", r.overwrite = !1, r.immediateRender = !0, r.lazy = h && !1 !== a.lazy, r.startAt = r.delay = null, r.onUpdate = a.onUpdate, r.onUpdateParams = a.onUpdateParams, r.onUpdateScope = a.onUpdateScope || a.callbackScope || this, this._startAt = D.to(this.target, 0, r), h)
                ...
                var a, o, l, h, _, u;
                if (null == e) return !1;
                z[e._gsTweenID] && H(), this.vars.css || e.style && e !== t && e.nodeType && Y.css && !1 !== this.vars.autoCSS && function(t, e) {
                    var i, s = {};
                ...
                } else i[a] = L.call(this, e, a, "get", u, a, 0, null, this.vars.stringFilter, n);
                return r && this._kill(r, e) ? this._initProps(e, i, s, r, n) : this._overwrite > 1 && this._firstPT && s.length > 1 && K(e, this, i, this._overwrite, s) ? (this._kill(i, e), this._initProps(e, i, s, r, n)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (z[e._gsTweenID] = !0), l)
            }, o.render = function(t, e, i) {
            ...
            if (o = tt.prototype, tt.version = "1.19.0", tt.API = 2, o._firstPT = null, o._addTween = L, o.setRatio = X, o._kill = function(t) {
...
//# sourceMappingURL=/sm/6a3bcf506bab0647638d315ba078a871399036b7d4fb6b293376c4d3d5dbf17e.map
